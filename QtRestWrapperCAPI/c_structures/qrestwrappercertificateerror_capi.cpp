...
{
    struct QRestWrapperCertificateError_CAPI *newObj = new QRestWrapperCertificateError_CAPI();
    newObj->m_url = qurlCapiFromString(nullptr, qRestWrapperCertificateError.url().toString().toUtf8().data());
