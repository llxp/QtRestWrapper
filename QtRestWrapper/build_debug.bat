...
SET outputpath=%binpath%\%projectname%d.dll
...
SET compilerflags=/MP /Od /Zi /EHsc /std:c++latest /c /nologo /Zc:wchar_t /FS /Zc:rvalueCast /Zc:inline /Zc:strictStrings /Zc:throwingNew /Zc:referenceBinding /Zc:__cplusplus /Zi /MDd /W3 /w34100 /w34189 /w44996 /w44456 /w44457 /w44458 /wd4577 /wd4467 /EHsc /DUNICODE /D_UNICODE /DWIN32 /D_ENABLE_EXTENDED_ALIGNED_STORAGE /DWIN64 /DQTRESTWRAPPER_LIBRARY /DQT_DEPRECATED_WARNINGS /DQT_QML_DEBUG /DQT_WEBENGINEWIDGETS_LIB /DQT_PRINTSUPPORT_LIB /DQT_WIDGETS_LIB /DQT_WEBENGINECORE_LIB /DQT_QUICK_LIB -DQT_GUI_LIB /DQT_WEBCHANNEL_LIB /DQT_QML_LIB /DQT_NETWORK_LIB /DQT_POSITIONING_LIB /DQT_CORE_LIB /D_WINDLL
SET linkerflags=/NOLOGO /DYNAMICBASE /NXCOMPAT /DEBUG /DLL /SUBSYSTEM:WINDOWS /MANIFEST:embed
SET mocflags=-DUNICODE -D_UNICODE -DWIN32 -D_ENABLE_EXTENDED_ALIGNED_STORAGE -DWIN64 -DQTRESTWRAPPER_LIBRARY -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_WEBENGINEWIDGETS_LIB -DQT_PRINTSUPPORT_LIB -DQT_WIDGETS_LIB -DQT_WEBENGINECORE_LIB -DQT_QUICK_LIB -DQT_GUI_LIB -DQT_WEBCHANNEL_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_POSITIONING_LIB -DQT_CORE_LIB -D_WINDLL --compiler-flavor=msvc
